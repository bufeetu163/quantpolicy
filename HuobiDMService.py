...
class HuobiDM(Base):
    ...
    def __init__(self,access_key='',secret_key=''):
        ...
        # self.__url='http://api.hbdm.vn/'
        access_key = 'bb744223-32147a86-56597f7f-ez2xc4vb6n'
        secret_key = '8bc9bf60-64d68dfc-2cc3f4f7-b08de'
        self.__access_key = access_key
        self.__secret_key = secret_key
    #批量按网格下单
    def order_piliang(self,coinname,price_start,jiange,times,volume,direction, offset,jingdu=3):
        i=1
        while i<=times:
            print(i)
            if direction=='buy':
            ...
            i=i+1
            res=self.send_contract_order(symbol=coinname, price=price, volume=volume, direction=direction, offset=offset)
            print(res)
            time.sleep(1)
    ...
    # 合约下单
    def send_contract_order(self,symbol,price,volume,direction,offset):
        params = {
